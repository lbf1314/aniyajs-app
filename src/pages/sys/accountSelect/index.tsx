...
import { Card, Row, Col, Spin, Button, Avatar, Typography, Result } from 'antd';
      ...
      {loginResult?.length > 0 ? (
        <>
                ...
                <Col xs={24} sm={12} lg={8} key={account.id}>
                  ...
                  >
                    <div className={styles["account-info"]}>
                      <div className={styles["avatar-section"]}>
                        {account.avatar ? (
                          ...
                          <Avatar size={64} icon={iconMap('UserOutlined')} />
                        )}
                      </div>
                    ...
                    <div className={styles["card-footer"]}>
                      {iconMap('ArrowRightOutlined', { color: '#00000073' })}
                    </div>
                  </Card>
                </Col>
              ))}
          ...
          <div className={styles["logout-section"]}>
            <Button icon={iconMap('LogoutOutlined')} onClick={handleLogout}>
              退出登录
            </Button>
          </div>
        </>
